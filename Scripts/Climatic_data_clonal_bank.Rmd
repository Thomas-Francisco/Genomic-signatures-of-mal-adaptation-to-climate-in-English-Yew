...
coords_CG <- data.frame(meta_data[,c(1,2)],Longitude=c("-4.0125"),Latitude=c("40.91056"))
...
Interpretation: The climatic range among the populations is significant, particularly regarding annual precipitation and temperature. For the clonal bank (CB), we observe that, compared to the other populations, the annual temperature is relatively high, especially during the driest quarter. Additionally, the temperature seasonality and diurnal temperature range are also important.
