---
title: "Climatic_data_Taxus_Spain"
...
```{r meta data}
meta_data_pop <- read.csv("C:/Users/tfrancisco/Documents/Thesis/Data/Species/Taxus_baccata/Populations/Taxus_Spain_pop.csv",h=T,sep=";",dec=",")
meta_data_vcf <- read.csv("C:/Users/tfrancisco/Documents/Thesis/Data/Species/Taxus_baccata/samples/Taxus_Spain_indiv.csv",h=T,sep=";",dec=",")
```
...
regions <-past_climatic_data_f$Region
...
Conclusion: we retained the subset: **BIO 1, 2, 4, 9, 12, 15** :
  ...
  **4. Future climatic data: processing and comparison of the different climatic models**
...
Past_clim_data_Spain_pop <- past_climatic_data_order[,c(1:4,6,10,12,15)]
...
#non scaled data
save(Past_clim_data_Spain_pop,file="C:/Users/tfrancisco/Documents/Thesis/Data/Species/Taxus_baccata/Climatic_data/Spain_pop/Past_clim_data_Spain_pop.Rdata" )
