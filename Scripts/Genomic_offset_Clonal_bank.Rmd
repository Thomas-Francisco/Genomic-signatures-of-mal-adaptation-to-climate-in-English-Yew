...
To achieve this, we are utilizing an indenpend set of populations planted in a single clonal bank garden located in central Spain (Segovia).
...
Load GEA models 
```{r load GEA models}
list_models <- c("model_GEA_RDA_all","model_GEA_RDA_random","model_GEA_RDA_random_same_AF","model_GEA_RDA_CG","model_GEA_RDA_outliers_LC","model_GEA_RDA_outliers_MC")
...
list_models <- c("random_neutral_set_SNPs_T_adapcon_gentree_bis","random_set_taxus","outliers_set_final_overlapping_no_LD_LC_new_var","outliers_set_final_overlapping_no_LD_new_var")
...
list_models <- c("all","random_bis","random_same_AF_bis","LC","CG")
...
list_set <- c("Run_GEA_GF_all","Run_GEA_GF_random_bis","Run_GEA_GF_random_same_AF_bis","Run_GEA_GF_LC","Run_GEA_GF_CG")
list_CG <- c("2012","2021")
vars <- colnames(clim_df_natural_pop)
list_name <- c("all","random","random_same_AF","LC","CG")
