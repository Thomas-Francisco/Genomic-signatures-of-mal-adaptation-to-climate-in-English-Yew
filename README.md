...
This script is associated with the publication [Francisco et al. 2025](https://onlinelibrary.wiley.com/doi/10.1111/eva.70160), published in *Evolutionary Applications* as part of the special issue titled *'Genomic assessment of adaptive potential of populations to environmental challenges: applications to management and conservation'.*   
The data supporting this study are archived in this [repository](https://entrepot.recherche.data.gouv.fr/dataset.xhtml?persistentId=doi%3A10.57745%2FJJ0ZEI&version=DRAFT).
